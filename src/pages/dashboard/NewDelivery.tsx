    ...
    <div className="w-full flex flex-col items-center gap-10 p-5 ">
        ...
        <div className="w-full flex flex-col items-center gap-2">
            <div className="flex items-center gap-2">
                ...
                <div className={`w-15 sm:w-30 h-1 rounded-lg transition-all duration-300 ${currentStep >= 2? 'bg-primary':'bg-gray-200'}`}></div>

                <div className={`w-10 h-10 rounded-full grid place-items-center transition-all duration-300
                ${currentStep >= 2? 'text-white bg-primary':'text-gray-600 bg-gray-200'}`}>2</div>

                <div className={`w-15 sm:w-30 h-1 rounded-lg transition-all duration-300 ${currentStep >= 3? 'bg-primary':'bg-gray-200'}`}></div>
