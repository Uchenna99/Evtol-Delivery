...
const MobileSidebarOption = ({ section, dropDown, confirmation }:Props) => {
  ...
  return (
    <>
        <motion.div className="relative h-16" 
            ...
            <div className={`w-full bg-white flex items-center gap-3 rounded-xl p-2 border border-gray-100 transition-all duration-300 
