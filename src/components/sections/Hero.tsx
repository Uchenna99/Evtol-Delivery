...
const Hero = () => {
  return (
    <div className="w-full h-[790px] flex flex-col gap-10 items-center bg-blue-200 bg-no-repeat bg-cover bg-center pt-20 px-4
        relative"
        style={{backgroundImage:`url(${background}) `}}>

        <div className="w-[800px] flex flex-col items-center gap-7 py-10 border-b border-white/30">
            <h1 className="text-white text-6xl font-bold text-center leading-snug">
                Revolutionizing Medical <br />
                <span className="">
                    Supply Delivery
                </span>
            </h1>
            <p className="text-white text-2xl text-center font-light leading-normal">
        ...
        <div className="w-[800px] flex items-center justify-around">

            <div className="min-w-fit flex flex-col items-center justify-center gap-2">
