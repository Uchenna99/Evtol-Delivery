...
const Testimonials = () => {
  return (
    <div className="w-full flex flex-col items-center gap-14 py-20 px-4">
        ...
        <div className="w-full max-w-[800px] bg-white rounded-2xl p-10 shadow-xl flex items-center gap-7">

            <div className="min-w-28 min-h-28 rounded-full bg-blue-100"></div>
